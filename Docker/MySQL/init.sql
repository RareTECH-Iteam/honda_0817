...
-- Aliceさんが作成したチャットルームを挿入
INSERT INTO chat (uid, name, abstract) VALUES
('1', '北海道住民1とのメッセージ', 'Aliceさんの最初のチャットルームです'),
('1', '北海道住民2とのメッセージ', 'Aliceさんのセカンドチャットルームです'),
('1', '東京都民1とのメッセージ', 'Aliceさんのサードチャットルームです'),
('1', '東京都民2とのメッセージ', 'Aliceさんのフォースチャットルームです'),
('1', '東京都民3とのメッセージ', 'Aliceさんのフィフスチャットルームです');

-- Aliceさんと他のユーザーのメッセージを挿入
